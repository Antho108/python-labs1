...
class Hero():
    ...
    def battle(self, other):  
        ...
        self.hand = random.randint(0, 7) * self.level
        other.hand = random.randint(0, 7) * other.level
...
class Opponent():
    ...
    def __init__(self, name, level, attack) -> None:
        self.name = name 
        self.level = level  
        self.attack = attack 
    pass
...
class SmallOpponent(Opponent):
    ...
    def __init__(self, name, level, attack) -> None:
        super().__init__(name, level, attack)
...
def Welcome(): 
    ...
    attack as well as a name, then join the labyrinth of the dead who kill.
      You will have the opportunity to face many opponents and to increase your level!
        When you have defeated every hero, you will be victorious. 
        Strength & Honor! Never give up, no matter how difficult it may seem to reach level 100 
        for your hero"""
    print(rules)
    pass
